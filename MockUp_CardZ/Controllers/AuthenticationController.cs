...
namespace MockUp_CardZ.Controllers
{
    ...
    public class AuthenticationController : Controller
    {
        ...
        //public AuthenticationController(IUserService userService, ICustomerService customerService, IOptions<JWT> jwt)
        //{
        ...
        //        var user = await _userService.Authentication(model.Username, model.Password, customerResult.DbName);
        ...
        //private JwtSecurityToken CreateJwtToken(UserEntity user)
        //{
